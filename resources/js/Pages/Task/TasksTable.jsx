            ...
            {tasks.data.map((task) => (
              ...
              >
                ...
                <td className="px-3 py-2">
                  <img src={task.image_path} alt="Task" style={{ width: 60 }} />
                </td>
                {!hideProjectColumn && (
                  <td className="px-3 py-2">{task.project ? task.project.name : "N/A"}</td>
                )}
                <td className="px-3 py-2">
                ...
                <td className="px-3 py-2">{task.createdBy ? task.createdBy.name : "N/A"}</td>
